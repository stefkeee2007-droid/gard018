    ...
    const sendTestEmail = async () => {
      ...
      try {
        const response = await fetch("/api/test-email", {
          ...
          body: JSON.stringify({ email: "stefkeee2007@gmail.com" }),
        })
        ...
        <div className="space-y-4">
          {loading && (
            <div className="text-center">
              ...
              <p className="text-gray-400">Šaljem test email na stefkeee2007@gmail.com...</p>
            </div>
          )}
          ...
          {result && (
            ...
            >
              ...
              <p className="text-xs text-gray-400">Email: stefkeee2007@gmail.com</p>
          ...
          {result?.success && (
            <Button onClick={() => (window.location.href = "/")} className="w-full bg-[#8f1528] hover:bg-[#8f1528]/80">
              Povratak na početnu
            </Button>
          )}
        </div>
